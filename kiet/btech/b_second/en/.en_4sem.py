...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NOE041_I","NOE041_E",'NEC459A_I','NEC459A_E','NEC409A_I','NEC409A_E','NEE451_I','NEE451_E','NEE401_I','NEE401_E','NEE452_I','NEE452_E','NEE402_I','NEE402_E','NEE453_I','NEE453_E','NEE403_I','NEE403_E','NHU402_I','NHU402_E','AUC002_I','AUC002_E',"GP","Total","CP","Result Status"]
