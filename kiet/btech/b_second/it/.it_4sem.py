...
import xlsxwriter
workbook = xlsxwriter.Workbook('IT4th.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NAS401_I","NAS401_E",'NCS451_I','NCS451_E','NEC408_I','NEC408_E','NIT451_I','NIT451_E','NCS401_I','NCS401_E','NCS455_I','NCS455_E','NCS402_I','NCS402_E','NIT456_I','NIT456_E','NIT401_I','NIT401_E','NHU401_I','NHU401_E','AUC001_I','AUC001_E',"GP","Total","CP","Result Status"]
