...
import xlsxwriter
workbook = xlsxwriter.Workbook('ECE4th.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NAS401_I","NAS401_E",'NEC451_I','NEC451_E','NEC401_I','NEC401_E','NEC452_I','NEC452_E','NEC402_I','NEC402_E','NEC453_I','NEC453_E','NEC403_I','NEC403_E','NEC454_I','NEC454_E','NEC404_I','NEC404_E','NHU401_I','NHU401_E','AUC002_I','AUC002_E',"GP","Total","CP","Result Status"]
