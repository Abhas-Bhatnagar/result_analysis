...
import xlsxwriter
workbook = xlsxwriter.Workbook('CIVIL4th.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NOE047_I","NOE047_E",'NCE451_I','NCE451_E','NCE401_I','NCE401_E','NCE452_I','NCE452_E','NCE402_I','NCE402_E','NCE453_I','NCE453_E','NCE403_I','NCE403_E','NCE455_I','NCE455_E','NCE404_I','NCE404_E','NHU402_I','NHU402_E','AUC002_I','AUC002_E',"GP","Total","CP","Result Status"]
