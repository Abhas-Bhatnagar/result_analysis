...
import xlsxwriter
workbook = xlsxwriter.Workbook('EI6th.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NIC601R_I","NIC601R_E",'NIC651R_I','NIC651R_E','NIC602_I','NIC602_E','NEC652B_I','NEC652B_E','NEC609_I','NEC609_E','NEC659_I','NEC659_E','NEC011_I','NEC011_E','NIC654_I','NIC654_E','NIC022_I','NIC022_E','NHU601_I','NHU601_E',"GP","Total","CP","Result Status"]
