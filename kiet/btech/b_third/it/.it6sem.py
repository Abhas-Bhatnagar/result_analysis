...
import xlsxwriter
workbook = xlsxwriter.Workbook('IT6sem.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NCS601_I","NCS601_E",'NCS651_I','NCS651_E','NCS602_I','NCS602_E','NCS652_I','NCS652_E','NCS603_I','NCS603_E','NCS653_I','NCS653_E','NIT061_I','NIT061_E','NIT654','NIT067_I','NIT067_E','NHU601_I','NHU601_E',"GP","Total","CP","Result Status"]
