...
import xlsxwriter
workbook = xlsxwriter.Workbook('CIVIL6th.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NCE601_I","NCE601_E",'NCE651_I','NCE651_E','NCE602_I','NCE602_E','NCE652_I','NCE652_E','NCE603_I','NCE603_E','NCE653_I','NCE653_E','NCE011_I','NCE011_E','NCE654','NCE021_I','NCE021_E','NHU601_I','NHU601_E',"GP","Total","CP","Result Status"]
