...
import xlsxwriter
workbook = xlsxwriter.Workbook('ECE6th.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NEC601_I","NEC601_E",'NEC651A_I','NEC651A_E','NEC602_I','NEC602_E','NEC652A_I','NEC652A_E','NEC603_I','NEC603_E','NEC653_I','NEC653_E','NEC011_I','NEC011_E','NEC654R','NEC022R_I','NEC022R_E','NEC655_I','NEC655_E','NHU601_I','NHU601_E',"GP","Total","CP","Result Status"]
	...
	try:
		...
		for col in range(22):
			...
			#print l[col]
		#print col
		worksheet.write(row,25,marks)
		worksheet.write(row,26,cop)
		worksheet.write(row,27,cp)
		print("check")
	except:
		print("check1")
	row+=1
