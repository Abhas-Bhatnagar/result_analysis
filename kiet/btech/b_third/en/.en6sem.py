...
import xlsxwriter
workbook = xlsxwriter.Workbook('EN.xlsx')										#NAME OF GENERATED FILE
...
for filename in glob.glob('*.html'):	
	...
	print(rollnumber+" \n"+name+" \n"+fathername+"\n"+marks+"\n"+cp+"\n"+cop)
	subjects=["RollNumber","Name","FatherName","NEE601_I","NEE601_E",'NEC651B_I','NEC651B_E','NEE602_I','NEE602_E','NEN652_I','NEN652_E','NEN603_I','NEN603_E','NEN653_I','NEN653_E','NEN014_I','NEN014_E','NEN654','NEN021_I','NEN021_E','NHU601_I','NHU601_E',"GP","Total","CP","Result Status"]
